...
Claude reads the skill, runs the pipeline, writes summaries to `wiki/sources/` and raw transcripts to `wiki/raw/podcasts/`, and surfaces any reversal-narrative warnings that need manual transcript verification.
